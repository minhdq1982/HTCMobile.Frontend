...
import { EditTenantComponent } from 'app/pages/tenants/edit-tenant/edit-tenant.component';
import { CreateTenantComponent } from 'app/pages/tenants/create-tenant/create-tenant.component';
